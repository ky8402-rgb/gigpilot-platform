            ...
            <div className="space-y-4 py-2 text-center">
              ...
              <div className="pt-2 flex flex-wrap items-center justify-center gap-2">
                <button
                  ...
                  title="Generate Official PDF with Payoneer Configured Payoneer account Payment Instructions"
                >
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                  ...
                  >
                    ...
                    <span className="text-[10px] text-sky-400 font-mono">Configured Payoneer account ACH / Wire</span>
                  </button>
                ...
                <div className="rounded-2xl border border-sky-500/40 bg-sky-950/20 p-4 space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-white flex items-center gap-1.5">
                      ...
                      <span>Primary Collection Account: Payoneer Configured Payoneer account USD Checking</span>
                    </span>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs font-mono bg-slate-950/80 p-3 rounded-xl border border-slate-800">
                    <div>
                      ...
                      <strong className="text-white">Configured Payoneer account</strong>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => handleCopy('Configured server-side')}
                    ...
                    <div>
                      ...
                      <div className="text-slate-200">
                        ABA: <strong className="text-sky-300">Configured server-side</strong> &bull; SWIFT: <strong className="text-cyan-300">Configured server-side</strong>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between flex-wrap gap-2 pt-1 text-xs">
                    <button
                      onClick={() => {
                        const instructions = `PRIMARY PAYMENT INSTRUCTIONS (Payoneer Configured Payoneer account USD Wire/ACH):\nBank Name: Configured Payoneer account\nBank Address: Configured server-side\nBeneficiary: Kundan Kumar\nAccount Number: Configured server-side\nAccount Type: CHECKING\nRouting (ABA): Configured server-side\nSWIFT / BIC: Configured server-side\nCurrency: USD\nAmount Due: $${amountUsd} USD`;
              ...
              {selectedMethod === 'paypal' && paymentLinks && (
                <div className="rounded-2xl border border-blue-500/30 bg-blue-950/15 p-4 space-y-3">
                  ...
                  <div className="flex items-center justify-between text-xs text-slate-400 pt-1">
                    <span>Destination: <strong>PayPal.me/Configured server-side</strong> <span className="text-slate-500">(Configured server-side)</span></span>
                    <a
