/**
 * Client-Side Hard Exclude Filters (Never Bid) Engine
 * 
 * Enforces immediate skip of any job containing:
 *  1. Physical / On-site
...
/**
 * Checks whether a job object or raw string triggers the Hard Exclude Filter
 */
